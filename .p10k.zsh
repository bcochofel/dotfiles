# Generated by Powerlevel10k configuration wizard on 2020-03-30 at 12:06 WEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 01588.
...
() {
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_TERRAFORM_PROD_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|fluxctl|stern'
